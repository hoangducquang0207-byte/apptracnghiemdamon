  ...
  "questions": [
    {
      ...
      "options": ["A. Phương án A có công thức toán như $x = 1$", "B. Phương án B", "C. Phương án C", "D. Phương án D"],
      "matchingRight": ["Cực 1 vế phải", "Cực 2 vế phải"],
      "correctAnswer": "Đáp án đúng (Nếu MCQ chọn 'A'/'B'/'C'/'D'; Nếu TRUE_FALSE chọn 'Đúng'/'Sai'; Nếu SHORT_ANSWER/FILL_BLANK chọn cụm từ viết hoa/thường chuẩn hoặc giá trị như $x = 2$; Nếu MATCHING chọn chuỗi cặp ví dụ '0-1, 1-0...'; Nếu SHORT_ESSAY chọn nội dung lời tự luận đáp án tóm tắt)",
...
- TRUE_FALSE: options và matchingRight đặt là null. correctAnswer chỉ nhận 'Đúng' hoặc 'Sai'.
